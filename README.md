...
| aws_subnet_id         | The AWS subnet ID to use for your runner. If omitted, the action tries the default VPC subnets across available Availability Zones. | false              | Default VPC subnets |
